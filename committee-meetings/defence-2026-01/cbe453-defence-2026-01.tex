...
\begin{frame}
	...
	\begin{columns}
		...
		\begin{column}{0.5\textwidth}
			\includegraphics[scale=0.325]{../../working-thesis/figures/gc-plot.pdf}
		\end{column}
...
\begin{frame}
	\frametitle{Genes are Sensitive}
	\begin{itemize}
	...
	\vspace{0.3cm}
	\centering
	\includegraphics[width=0.6\textwidth]{./subcellular-localization.jpg}
\end{frame}

\begin{frame}
	\frametitle{Uncertainty in Gene Predictions}
	\centering
...
\begin{frame}
	...
	\begin{itemize}
		\item Before diving too deep, how can we objectively confirm that gene finding tools predict different genes?
...
\begin{frame}
	...
	\centering
	\includegraphics[width=0.87\textwidth]{../../working-thesis/figures/workflow-simple.pdf}
\end{frame}
...
\begin{frame}
	...
	\begin{itemize}
		...
		\item Braker2 generally performs best, particularly when relevant training data is available.
		\item Candidate secondary metabolite gene clusters were found in both DC1 and Tsth20 assemblies.
...
\begin{frame}
	\frametitle{Regions}
	\includegraphics[width=\textwidth]{../../working-thesis/figures/igv/igv-agreement.png}
\end{frame}
