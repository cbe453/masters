...
that do not truly exist in those regions. However, this may not be as
common today, as repetetive regions have been shown to contain genes
as well\cite{dontMask}. This may affect the gene finding process
...
least according table 1 of Wang, Z \textit{et
...
and performance of gene callers in AT-rich regions. Results from this
...
\item A final table(s) including the criteria mentioned above along
  with performance for each gene finder relative to the genome
  considered.
\end{itemize}
