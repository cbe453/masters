...
assemblies. Short reads may be unable to bridge or cover entire repeat
regions within a genome, so it is important to consider the use of
long reads such as Nanopore or PacBio when pursuing a new genome
assembly project. It is also possible for these repetitive regions to
