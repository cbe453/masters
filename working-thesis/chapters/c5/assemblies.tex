...
\begin{figure}
  ...
  \end{center}
  \caption[GC content distribution for each Trichoderma genome assembly]{Plots showing proportions of sliding windows with specific GC content
    for each \textit{Trichoderma} genome assembly. The vertical dashed line at indicates the cutoff point used to distinguish AT-rich sequences.}\label{fig:assembly-gc}
\end{figure}
