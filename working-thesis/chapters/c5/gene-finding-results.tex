...
the definition could be made more specific in the future to include introns,
...
potential coding sequences for a gene. A coding sequence in this context is a sequence of nucleotides transcribed from a gene.
In this work, we refer to
\textit{coding sequences} as the set of all coding sequences predicted by a
