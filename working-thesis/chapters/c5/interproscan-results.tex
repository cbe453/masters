...
is disagreement in several forms. We also note that 
the lack of a Pfam match does not necessarily indicate an incorrect gene prediction, as not all proteins have known domains in the Pfam database. Further investigation of genes without Pfam hits is still warranted to determine their validity.
