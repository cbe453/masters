...
\cbstart
Relating these observations to use-case scenarios requires consideration of the data available to the user. If relevant high-quality training data is available, Braker2 is the best option. If no training data is available, GeneMark is a reasonable choice, and although its performance is not as good as Braker2, it still predicts a useful set of genes with InterProScan support. If your organism were to be annotated by the RefSeq pipeline, then you can expect good performance from their annotations as well, although RefSeq ranks lowest in BUSCO and InterProScan categories from these results.
\cbend
...
\begin{table}
  ...
  \begin{tabular}{|c|c|c|c|}
    ...
    Availability & 2 & 2 & N/A \\ \hline
    Ease of install & 1 & 2 & N/A \\ \hline
    Ease of use & 2 & 2 & N/A \\ \hdashline
